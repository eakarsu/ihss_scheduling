...
// Batch 10 frontend page: "No AI turnover / churn prediction" (ai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-ai-turnover-churn-prediction";
const LABEL = "No AI turnover / churn prediction";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-ai-turnover-churn-prediction";

export default function GapNoAiTurnoverChurnPrediction() {
