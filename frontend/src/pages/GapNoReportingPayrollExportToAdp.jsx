...
// Batch 10 frontend page: "No reporting / payroll export to ADP/Gusto" (nonai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-reporting-payroll-export-to-adp";
const LABEL = "No reporting / payroll export to ADP/Gusto";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-reporting-payroll-export-to-adp";

export default function GapNoReportingPayrollExportToAdp() {
