...
// Batch 10 frontend page: "No AI compliance violation early-warning" (ai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-ai-compliance-violation-early-warning";
const LABEL = "No AI compliance violation early-warning";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-ai-compliance-violation-early-warning";

export default function GapNoAiComplianceViolationEarlyWarning() {
