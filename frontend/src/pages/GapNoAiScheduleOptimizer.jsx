...
// Batch 10 frontend page: "No AI schedule optimizer" (ai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-ai-schedule-optimizer";
const LABEL = "No AI schedule optimizer";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-ai-schedule-optimizer";

export default function GapNoAiScheduleOptimizer() {
