...
// Batch 10 frontend page: "Turnover-risk model with retention playbooks" (cfs) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "turnover-risk-model-with-retention-playbooks";
const LABEL = "Turnover-risk model with retention playbooks";
const SECTION = "cfs";
const API_PATH = "/api/cf-turnover-risk-model-with-retention-playbooks";

export default function CfTurnoverRiskModelWithRetentionPlaybooks() {
