...
// Batch 10 frontend page: "No mobile self-service app" (nonai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-mobile-self-service-app";
const LABEL = "No mobile self-service app";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-mobile-self-service-app";

export default function GapNoMobileSelfServiceApp() {
