...
// Batch 10 frontend page: "No notifications (push/SMS) for shift changes" (nonai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-notifications-push-sms-for-shift";
const LABEL = "No notifications (push/SMS) for shift changes";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-notifications-push-sms-for-shift";

export default function GapNoNotificationsPushSmsForShift() {
