...
// Batch 10 frontend page: "HRIS / payroll provider integrations (ADP, Gusto, Workday)" (cfs) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "hris-payroll-provider-integrations-adp-gusto";
const LABEL = "HRIS / payroll provider integrations (ADP, Gusto, Workday)";
const SECTION = "cfs";
const API_PATH = "/api/cf-hris-payroll-provider-integrations-adp-gusto";

export default function CfHrisPayrollProviderIntegrationsAdpGusto() {
