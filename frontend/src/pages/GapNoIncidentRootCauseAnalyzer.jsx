...
// Batch 10 frontend page: "No incident root-cause analyzer" (ai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-incident-root-cause-analyzer";
const LABEL = "No incident root-cause analyzer";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-incident-root-cause-analyzer";

export default function GapNoIncidentRootCauseAnalyzer() {
