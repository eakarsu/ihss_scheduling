...
// Batch 10 frontend page: "No employee sentiment / fatigue scoring" (ai-gap) — ihss_scheduling
import React, { useEffect, useState } from 'react';

const SLUG = "no-employee-sentiment-fatigue-scoring";
const LABEL = "No employee sentiment / fatigue scoring";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-employee-sentiment-fatigue-scoring";

export default function GapNoEmployeeSentimentFatigueScoring() {
