...
export default function Login({ onLogin }) {
  ...
  const fillCredentials = () => { setEmail('admin@ihss.com'); setPassword('password123'); setError(''); };
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.logo}>
          ...
          <div style={styles.logoSub}>Territory-Based Workforce Scheduling Platform</div>
        </div>
        ...
        <div style={styles.divider}><div style={styles.line}></div><span>Quick Access</span><div style={styles.line}></div></div>
        <button style={styles.fillBtn} onClick={fillCredentials}
        ...
        >Fill Demo Credentials (admin@ihss.com)</button>
      </div>
    </div>
  );
}
