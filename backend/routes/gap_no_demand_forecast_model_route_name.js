...
// Batch 10 Gap: "No demand forecast model (route name implies model but logic is likely rules)" (ai-gap) for ihss_scheduling
// Mount path: /api/gap-no-demand-forecast-model-route-name
